...
namespace GS.PflanzenCMS.Rest.SDK.Client
{
    public class Context 
    {
        ...
        public GS.PflanzenCMS.Rest.SDK.Models.Dialog GetOrdersDialog()
        {
            var client = createClient();
            var request = new RestRequest("api/orders/dialog", Method.POST);
            return executeRequest<GS.PflanzenCMS.Rest.SDK.Models.Dialog>(request);
        }
        ...
        {
            return find<GS.PflanzenCMS.Rest.SDK.Models.GallerySlide>("api/channels/monitor/slides/" + id, search, pageIndex, pageSize, orderBy, filter);
        }

        public GS.PflanzenCMS.Rest.SDK.Models.Dialog GetMonitorPlayer(long id)
        {
            var client = createClient();
        ...
        public GS.PflanzenCMS.Rest.SDK.Models.Category GetCategoryByKey(string key)
        {
            throw new NotImplementedException();
        }

        // Countries
        public GS.PflanzenCMS.Rest.SDK.Models.Country GetCountry(string key)
        {
            throw new NotImplementedException();
        }
        ...
        public GS.PflanzenCMS.Rest.SDK.Models.Producer GetProducerByKey(string key)
        {
            throw new NotImplementedException();
        }
        ...
        public GS.PflanzenCMS.Rest.SDK.Models.ArticleGroup GetArticleGroupByKey(string key)
        {
            throw new NotImplementedException();
        }

        // Articles
        public GS.PflanzenCMS.Rest.SDK.Models.Dialog GetArticleDialog(long id)
        {
            var client = createClient();
        ...
        public Paginated<GS.PflanzenCMS.Rest.SDK.Models.Page.Summary> FindPages(long? parentId, string search, int pageIndex, int pageSize, string orderBy, string filter = null)
        {
            return find<GS.PflanzenCMS.Rest.SDK.Models.Page.Summary>("api/pages/childs/" + (parentId!=null ? parentId.Value : 0), search, pageIndex, pageSize, orderBy, filter);
        }

        // Containers
        public GS.PflanzenCMS.Rest.SDK.Models.Container GetContainerByKey(string key)
        {
            return get<GS.PflanzenCMS.Rest.SDK.Models.Container>("api/containers/key/{id}", key);
        }

        // Galleries

        public GS.PflanzenCMS.Rest.SDK.Models.Gallery GetGalleryByKey(string key)
        {
            return get<GS.PflanzenCMS.Rest.SDK.Models.Gallery>("api/galleries/key/{id}", key);
        }
